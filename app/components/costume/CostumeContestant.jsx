						...
						<div className="row ">
							<div className="col">
								{this.props.voted ? (
									...
									>
										Du har stemt på {this.props.teamname}
									</button>
								) : (
									<button
										onClick={this.vote}
							...
							{isAdminAuthenticated() && (
								<div className="col">
									<button
										onClick={this.deleteCostume}
										type="button"
										className="btn btn-danger"
									>
										Slett {this.props.teamname}
									</button>
								</div>
							)}
						</div>
							...
							this.props.votes && (
								<div className="row">
									<div className="col center-text">
										Antall stemmer: {this.props.votes.count}{' '}
										- {this.props.votes.percentage} %
									</div>
								</div>
							)}
					</div>
