    ...
    render() {
        ...
        return (
            <Modal isOpen={this.props.modalIsOpen} toggle={this.props.toggleModal}>
                ...
                {
                    this.state.loading || this.state.uploading ?  <LoadingSpinner />
                    :
                    <ModalFooter>
                        <Button color="secondary" onClick={this.props.toggleModal}>Avbryt</Button>{' '}
                        <Button color="primary" onClick={this.uploadImage}>Send</Button>
                    </ModalFooter>
                }
            </Modal>
        )
